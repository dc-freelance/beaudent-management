    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            <x-text-input id="email"
                class="mt-1 w-full p-2 rounded-lg text-sm border border-slate-200 placeholder:text-xs placeholder:ml-3 focus:ring-0 transition duration-300 ease-in-out focus:border-red-400 placeholder:capitalize"
        ...
        <div class="mt-1">
            <x-text-input id="password"
                class="mt-3 w-full p-2 rounded-lg text-sm border border-slate-200 placeholder:text-xs placeholder:ml-3 focus:border-red-400 focus:ring-0 transition duration-300 ease-in-out placeholder:capitalize"
