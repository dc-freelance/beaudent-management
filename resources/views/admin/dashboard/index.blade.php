        ...
        <div class="w-full h-full">
            <div class="flex flex-col col-span-full xl:col-span-8 bg-white shadow-lg rounded-sm border border-gray-200">
                <header class="px-5 py-4 border-b border-gray-100 flex items-center">
                    <h2 class="font-semibold text-lg text-gray-800">Pemasukan</h2>
                    <p class="text-gray-900 dark:text-white text-2xl leading-none font-bold ml-4">
                        {{ $data['pemasukan_tahun'] }}
                    </p>
                </header>
                <div class="flex-grow">
