                ...
                @role('frontoffice')
                    ...
                    <div class="flex justify-center mt-4">
                        <button data-modal-target="check-modal" data-modal-toggle="check-modal"
                            class="focus:outline-none text-white font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 bg-green-600 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                            type="button">
                            Lakukan Pemeriksaan
                        </button>
                    </div>
