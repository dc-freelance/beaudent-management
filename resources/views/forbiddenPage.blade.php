    ...
    <div class="min-w-screen min-h-screen bg-red-50 flex items-center p-5 lg:p-20 overflow-hidden relative">
        <div
            ...
            <div class="w-full md:w-1/2 text-center">
                ...
                <svg class="w-full max-w-lg lg:max-w-full mx-auto" xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 500 500">
                    ...
                    <g id="freepik--Character--inject-3">
                        ...
                        <path
                            ...
                            style="fill:orange;stroke:#263238;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.166343341900884px">
                        </path>
                        <path
                    ...
                    <g id="freepik--security-barrier--inject-3">
                        ...
                        <rect x="55.73" y="293.21" width="271.93" height="26.36"
                            style="fill:orange;stroke:#263238;stroke-miterlimit:10;stroke-width:1.166343341900884px">
                        </rect>
