...
<body class="h-full bg-slate-200">
    <div class="min-w-screen min-h-screen bg-red-50 flex items-center p-5 lg:p-20 overflow-hidden relative">
        ...
        <div
            class="w-64 md:w-96 h-96 md:h-full bg-red-200 bg-opacity-30 absolute -top-64 md:-top-96 right-20 md:right-32 rounded-full pointer-events-none -rotate-45 transform">
        </div>
        <div
            class="w-96 h-full bg-red-300 bg-opacity-20 absolute -bottom-96 right-64 rounded-full pointer-events-none -rotate-45 transform">
        </div>
    </div>
