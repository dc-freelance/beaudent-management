        ...
        <div
            ...
            <div class="w-full md:w-1/2">
                <div class="mb-10 md:mb-20 text-gray-600 font-light">
                    <h1 class="font-black uppercase text-3xl lg:text-5xl text-red-400 mb-10">sepertinya kamu
                        tersesat!
                    </h1>
                    <p>Halaman yang Anda cari tidak tersedia.</p>
                    <p>Coba cari lagi atau gunakan tombol Kembali di bawah.</p>
                </div>
            ...
            <div class="w-full md:w-1/2 text-center">
                <img src="{{ asset('assets/images/error-404.svg') }}" alt="">
            </div>
        </div>
        <div
            class="w-64 md:w-96 h-96 md:h-full bg-red-300 bg-opacity-30 absolute -top-64 md:-top-96 right-20 md:right-32 rounded-full pointer-events-none -rotate-45 transform">
        </div>
        <div
