...
<div>
    ...
    <input type="{{ $type }}" id="{{ $id }}" data-format="{{ $format }}"
        ...
        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 transition duration-300 block w-full p-2.5 {{ $class }}"
